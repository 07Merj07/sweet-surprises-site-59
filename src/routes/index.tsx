...
const childhood = { url: "/photos/childhood.jpg" };
const boat = { url: "/photos/boat.jpg" };
const storeKiss = { url: "/photos/storeKiss.jpg" };
const mirrorHug = { url: "/photos/mirrorHug.jpg" };
const violetLight = { url: "/photos/violetLight.jpg" };
const nightBlur = { url: "/photos/nightBlur.jpg" };
const flowers = { url: "/photos/flowers.jpg" };
const summerHat = { url: "/photos/summerHat.jpg" };
const prints = { url: "/photos/prints.jpg" };
const mallFriends = { url: "/photos/mallFriends.jpg" };
const storyStation = { url: "/photos/storyStation.jpg" };
const lakeKiss = { url: "/photos/lakeKiss.jpg" };
const mirrorCheek = { url: "/photos/mirrorCheek.jpg" };
const nightRoses = { url: "/photos/nightRoses.jpg" };
const lakeHug = { url: "/photos/lakeHug.jpg" };
const windowLight = { url: "/photos/windowLight.jpg" };
const jerseys = { url: "/photos/jerseys.jpg" };
const headsTogether = { url: "/photos/headsTogether.jpg" };
const mirrorKiss = { url: "/photos/mirrorKiss.jpg" };
const shopSmile = { url: "/photos/shopSmile.jpg" };
const jerseyKiss = { url: "/photos/jerseyKiss.jpg" };
const snowKiss = { url: "/photos/snowKiss.jpg" };
const nightSelfie = { url: "/photos/nightSelfie.jpg" };
const windowGirl = { url: "/photos/windowGirl.jpg" };
...
const scenes = [
  ...
  },
  {
    ...
    body: "I love everything about you, but your eyes are something else. How have they been glowing with the exact same beauty since childhood !! ?",
    align: "left" as const,
    focus: "50% 35%",
  },
  {
    ...
    body: "I won't make this too long, but we're definitely on the same page about how special this day is for both of us, aren't we? hhh",
  ...
  },
  {
    ...
    title: "You Look Beautiful in the Middle of Everything",
    body: "You remember this day, don't you hhh? The day your boy stepped right out of the sky!",
    align: "left" as const,
    focus: "62% 45%",
  },
  {
  ...
  },
  {
    ...
    body: "You look like an angel in that mirror, and I still cannot believe you are mine.",
    align: "left" as const,
    focus: "50% 20%",
  },
  {
  ...
  },
  {
    ...
    title: "That Smile and Those Sweet Little Eyes",
    body: "Those sweet little eyes of yours, a silly aisle, and the best smile in the world pointed straight at the camera. Baobao, you make cheap places look expensive.",
    align: "right" as const,
    focus: "50% 45%",
  },
  {
